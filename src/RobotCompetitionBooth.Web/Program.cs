...
builder.Services.AddSingleton<RobotHardwareConfigurationStore>();
builder.Services.AddSingleton<RobotHardwareConfigurationStatusService>();
...
builder.Services.AddSingleton<RobotHardwareConfigurationDeploymentService>();
